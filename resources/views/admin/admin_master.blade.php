...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{URL::to('public/assets/bootstrap/css/bootstrap-datetimepicker.min.css')}}">
        <link rel="stylesheet" href="{{URL::to('public/assets/bootstrap/css/bootstrap-datetimepicker-standalone.css')}}">
        <!-- Font Awesome -->
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href="{{URL::to('/add-bus-details')}}">
                                <i class="fa fa-bus"></i> <span>Add Bus Details</span>

                            </a>

                        </li>
                          <li class="active treeview">
                            <a href="{{URL::to('/manage-bus-details')}}">
                                <i class="fa fa-sun-o"></i> <span>Manage Bus Details</span>

                            </a>

                        </li>
                        <li class="active treeview">
                            <a href="{{URL::to('/add-route-details')}}">
                                <i class="fa fa-road"></i> <span>Add Route</span>

                            </a>

                        </li>
                        <li class="active treeview">
                            <a href="{{URL::to('/manage-route')}}">
                                <i class="fa fa-road"></i> <span>Manage Route</span>

                            </a>

                        </li>
                        <li class="active treeview">
                            <a href="{{URL::to('/add-counter')}}">
                                <i class="fa fa-road"></i> <span>Add Counter</span>

                            </a>
                        </li>
                        <li class="active treeview">
                            <a href="{{URL::to('/manage-counter')}}">
                                <i class="fa fa-road"></i> <span>Manage Counter</span>
                        ...
                        <li class="active treeview">
                            <a href="{{URL::to('/Passenger_details')}}">
                                <i class="fa fa-road"></i> <span>Passenger Details</span>
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
<!--                <h1>Welcome {{Session::get('admin_name')}} !</h1>-->
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy;<a href="http://www.ictd.gov.bd/"></a> 2017.</strong> All rights
                reserved.
            </footer>
...
$.widget.bridge('uibutton', $.ui.button);
        ...
        <script src="{{URL::to('public/assets/bootstrap/js/bootstrap-datetimepicker.min.js')}}"></script>
