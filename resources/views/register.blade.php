    ...
    <body class="hold-transition register-page">
        <div class="register-box">
            <div class="register-logo">
                <span class="logo-lg"><img style="margin: 0 auto;" class="img-responsive" width="110" height="30" src="{{URL::to('public/assets/dist/img/ictlogo.png')}}"></span>
                <a href="../../index2.html"><b>E-</b>STORE</a>
            </div>
            ...
            <div class="register-box-body">
                ...
                <h3><?php
                    ...
                    ?></h3>
                {!! Form::open(['url' => '/save-user','class'=>'form-horizontal','method'=>'post']) !!}
                <div class="form-group has-feedback">
                    <input type="text" name="login_name" class="form-control" placeholder="Full name">
                ...
                <div class="form-group has-feedback">
                    <input type="password"  name="login_password_c"class="form-control" placeholder="Retype password">
